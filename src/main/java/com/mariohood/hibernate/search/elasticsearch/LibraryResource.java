package com.mariohood.hibernate.search.elasticsearch;
...
import com.mariohood.hibernate.search.elasticsearch.model.Author;
import com.mariohood.hibernate.search.elasticsearch.model.Book;
...
public class LibraryResource {
    ...
    @Path("author/search")
    @Transactional
    public List<Author> searchAuthors(@RestQuery String pattern, @RestQuery Optional<Integer> size) {
